...
<li data-practice-item-id="<?= $item['id'] ?>"
    class='rounded-2xl relative bg-no-repeat overflow-clip before:absolute before:inset-0 before:bg-linear-to-b before:from-transparent before:to-white/91 bg-cover bg-center shadow-accent px-6 py-8 md:px-8 md:py-10 h-65 md:h-75 flex flex-col'
