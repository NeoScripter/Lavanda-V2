 ...
 */
export declare function validatedForPositioning(targetEl: HTMLElement | null, anchorName: string | null, anchorSelectors: Selector[], scopeSelectors: Selector[], options: {
    roots: AnchorPositioningRoot[];
}): Promise<HTMLElement | import("./dom.js").PseudoElement | null>;
